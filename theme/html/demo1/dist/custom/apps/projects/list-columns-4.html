									...
									<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-4">
													<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">Citrix - Technology</a>
												</div>
												<!--end::Name-->
												<!--begin::Label-->
									...
									<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-4">
													<a href="#" class="text-dark font-weight-bold text-hover-warning font-size-h4">GAP - Fashion Trends</a>
												</div>
												<!--end::Name-->
												<!--begin::Label-->
												<span class="btn btn-text btn-light-warning btn-sm font-weight-bold">Active</span>
									...
									<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
										<div class="card card-custom card-stretch p-0 gutter-b">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-4">
													<a href="#" class="text-dark font-weight-bold text-hover-warning font-size-h4">Nokia - Mobile Innovator</a>
												</div>
												<!--end::Name-->
												<!--begin::Label-->
												<span class="btn btn-text btn-light-success btn-sm font-weight-bold">Active</span>
