...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>ECommerce Dashboard 5 | Keenthemes</title>
		<meta name="description" content="ECommerce Dashboard 5" />
								...
								<div class="d-flex flex-row">
									...
									<div class="flex-row-fluid ml-lg-8">
										...
										<div class="card card-custom gutter-b gutter-b">
											...
											<div class="rounded bgi-position-x-right bgi-position-y-bottom bgi-no-repeat position-absolute top-0 left-0 right-0 bottom-0" style="background-image:url(assets/media/svg/shapes/abstract-6.svg);"></div>
											...
											<div class="card-body d-flex flex-column flex-md-row flex-lg-column flex-xxl-row px-12 py-11">
												...
												<div class="d-flex flex-root">
													<img src="assets/media/products/13.png" style="width: 100%; transform: scale(1.1) translateY(30px);" />
												</div>
											</div>
											<!--end:: Card body-->
										</div>
											...
											<div class="col-md-4 col-lg-12 col-xxl-4">
												...
												<div class="card card-custom card-stretch gutter-b">
													...
													<div class="card-body">
														...
														<div class="text-muted font-weight-bold font-size-sm mb-6">More than 400+ new members</div>
														<div class="font-size-sm mb-6">Outlines keep you honest. They stop you from indulging in poorly to metaphorsy about driving ought out</div>
														<!--begin::Info-->
															...
															<table class="table table-borderless mb-0">
																<tbody>
																	...
																	<tr>
																		...
																		<td class="font-weight-bold text-muted text-right align-middle pb-6">ReactJS, HTML</td>
																	...
																	<tr>
																		...
																		<td class="font-weight-bold text-muted text-right align-middle pb-6">Python, MySQL</td>
																	...
																	<tr>
																		...
																		<td class="font-weight-bold text-muted text-right align-middle pb-6">Laravel, Symphony</td>
																	...
																	<tr>
																		...
																		<td class="font-weight-bold text-muted text-right align-middle">AngularJS, C#</td>
