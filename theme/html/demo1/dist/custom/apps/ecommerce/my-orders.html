...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>ECommerce My Orders | Keenthemes</title>
		<meta name="description" content="ECommerce My Orders" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
										...
										<div class="card card-custom">
											...
											<div class="card-header flex-wrap border-0 pt-6 pb-0">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-1 font-weight-bold font-size-sm">Manage over 1600 products</span>
												</h3>
												<div class="card-toolbar">
													<!--begin::Dropdown-->
		...
		<script src="assets/js/pages/custom/ecommerce/my-orders.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>