						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center">
									...
									<!--end::Button-->
									<!--begin::Button-->
									<a href="custom/apps/user/add-user.html" class="btn btn-light-primary font-weight-bold btn-sm px-5 font-size-base ml-2">Add User</a>
									<!--end::Button-->
									<!--begin::Dropdown-->
									...
									<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
										...
										<div class="card card-custom gutter-b card-stretch">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-2">
													<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">Sarah May</a>
												</div>
												<!--end::Name-->
												<!--begin::Label-->
												<a href="#" class="label label-inline label-lg label-light-warning font-weight-bold">Active</a>
												<!--end::Label-->
												<!--begin::Buttons-->
												<div class="mt-9 mb-6">
													<a href="#" class="btn btn-md btn-icon btn-light-facebook btn-pill mx-2">
									...
									<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
										...
										<div class="card card-custom gutter-b card-stretch">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-2">
													<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">Teresa Wild</a>
												</div>
												<!--end::Name-->
												<!--begin::Label-->
												<a href="#" class="label label-inline label-lg label-light-primary font-weight-bold">Active</a>
									...
									<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
										...
										<div class="card card-custom gutter-b card-stretch">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-2">
													<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">Luca Doncic</a>
												</div>
												<!--end::Name-->
												<!--begin::Label-->
												<a href="#" class="label label-inline label-lg label-light-danger font-weight-bold">Active</a>
												<!--end::Label-->
												<!--begin::Buttons-->
												<div class="mt-9 mb-6">
													<a href="#" class="btn btn-md btn-icon btn-light-facebook btn-pill mx-2">
									...
									<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
										...
										<div class="card card-custom gutter-b card-stretch">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-2">
													<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">Cody Morgan</a>
												</div>
												<!--end::Name-->
												<!--begin::Label-->
												<a href="#" class="label label-inline label-lg label-light-primary font-weight-bold">Active</a>
