...
<html lang="en">
	...
	<head><base href="../../../../">
		<meta charset="utf-8" />
		<title>School Calendar | Keenthemes</title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">School Calendar</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label font-weight-bolder text-dark">School Calendar</span>
											<span class="text-muted mt-1 font-weight-bold font-size-sm">Events &amp; Happenings</span>
										</h3>
		...
		<script src="assets/js/pages/custom/education/school/calendar.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>