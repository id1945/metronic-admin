...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Tasks Documents | Keenthemes</title>
		<meta name="description" content="Tasks documents listing" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Tasks Documents</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Docs</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
													...
													<div class="d-flex align-items-center mr-2 py-2">
														...
														<div class="d-flex mr-3">
															...
															<div class="navi navi-hover navi-active navi-link-rounded navi-bold d-flex flex-row">
																...
																<!--begin::Item-->
																<div class="navi-item mr-2">
																	<a href="custom/apps/todo/docs.html" class="navi-link active">
															...
															<ul class="navi navi-link-rounded navi-accent navi-hover flex-column mb-8 mb-lg-0" role="tablist">
																...
																<li class="navi-item my-2">
																	<a class="navi-link" data-toggle="tab" href="#">
																		<span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Buying</span>
																	</a>
																</li>
																<!--end::Item-->
																<!--begin::Item-->
																<li class="navi-item mb-2">
																	<a class="navi-link active" data-toggle="tab" href="#">
																		<span class="navi-text text-dark font-size-h6 font-weight-bold">Product Support</span>
																	</a>
																</li>
																<!--end::Item-->
																<!--begin::Item-->
																<li class="navi-item mb-2">
																	<a class="navi-link" data-toggle="tab" href="#">
																		<span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Account Management</span>
																	</a>
																</li>
																<!--end::Item-->
																<!--begin::Item-->
																<li class="navi-item mb-2">
																	<a class="navi-link" data-toggle="tab" href="#">
																		<span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Product Licenses</span>
																	</a>
																</li>
																<li class="navi-item mb-2">
																	<a class="navi-link" data-toggle="tab" href="#">
																		<span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Base Installation</span>
																	</a>
																</li>
																<!--end::Item-->
																<!--begin::Item-->
																<li class="navi-item mb-2">
																	<a class="navi-link" data-toggle="tab" href="#">
																		<span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Project Management</span>
																	</a>
																</li>
																<!--end::Item-->
																<!--begin::Item-->
																<li class="navi-item mb-2">
																	<a class="navi-link" data-toggle="tab" href="#">
																		<span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Member Roles</span>
																	</a>
																</li>
																<!--end::Item-->
																<!--begin::Item-->
																<li class="navi-item mb-2">
																	<a class="navi-link" data-toggle="tab" href="#">
																		<span class="navi-text text-dark-50 font-size-h6 font-weight-bold">Report Generation</span>
																	</a>
																</li>
																<!--end::Item-->
																<!--begin::Item-->
															...
															<div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle" id="faq">
																...
																<div class="card">
																	<div class="card-header" id="faqHeading1">
																		<div class="card-title text-dark" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1" role="button">
																	...
																	<div id="faq1" class="collapse show" aria-labelledby="faqHeading1" data-parent="#faq">
																		<div class="card-body text-dark-50 line-height-lg pl-12">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.</div>
																	</div>
																</div>
																<!--end::Card-->
																<div class="card border-top-0">
																	<div class="card-header" id="faqHeading2">
																		<div class="card-title collapsed text-dark" data-toggle="collapse" data-target="#faq2" aria-expanded="false" aria-controls="faq2" role="button">
																			<span class="svg-icon svg-icon-primary">
																				<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
																				<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																					<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
