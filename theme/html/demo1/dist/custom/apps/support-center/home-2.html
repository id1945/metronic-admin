									...
									<div class="card-body d-flex justify-content-center flex-column col-lg-6 px-8 py-20 px-lg-20 py-lg-40">
										...
										<form class="d-flex position-relative flex-row-fluid">
											<div class="input-group shadow-sm">
												...
												<!--end::Icon-->
												<!--begin::Input-->
												<input type="text" class="form-control h-auto border-0 py-7 px-1 font-size-lg" placeholder="Ask a question" />
												<!--end::Input-->
											</div>
										</form>
										<!--end::Form-->
									...
									<div class="position-relative px-20">
										<ul class="nav nav-tabs nav-tabs-line" role="tablist">
											...
											<li class="nav-item mr-14 mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0 active" data-toggle="tab" href="#kt_tabs_6_1">Get Started</a>
											</li>
											<!--end::Nav Item-->
											<!--begin::Nav Item-->
											<li class="nav-item mr-14 mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab" href="#kt_tabs_6_2">Video Tutorials</a>
											</li>
											<!--end::Nav Item-->
											<!--begin::Nav Item-->
											<li class="nav-item mr-14 mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab" href="#kt_tabs_6_3">License Terms</a>
											</li>
											<!--end::Nav Item-->
											<!--begin::Nav Item-->
											<li class="nav-item mr-14 mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab" href="#kt_tabs_6_4">Copyright</a>
											</li>
											<!--end::Nav Item-->
											<!--begin::Nav Item-->
											<li class="nav-item mr-14 mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab" href="#kt_tabs_6_5">Tax &amp; Compliance</a>
											</li>
											<!--end::Nav Item-->
											<!--begin::Nav Item-->
											<li class="nav-item mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" data-toggle="tab" href="#kt_tabs_6_6">Support</a>
											</li>
											<!--end::Nav Item-->
										</ul>
									</div>
													...
													<div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle" id="accordionExample8">
														...
														<div class="card">
															...
															<div class="card-header" id="headingOne8">
																<div class="card-title" data-toggle="collapse" data-target="#collapseOne8" aria-expanded="true" aria-controls="collapseOne8" role="button">
																	<span class="svg-icon svg-icon-primary">
																		<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															...
															<div id="collapseOne8" class="collapse show" aria-labelledby="headingOne8" data-parent="#accordionExample8">
																<div class="card-body text-dark-50 font-size-lg pl-12">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.</div>
															</div>
															<!--end::Body-->
														</div>
														<!--end::Item-->
														...
														<div class="card">
															...
															<div class="card-header" id="headingTwo8">
																<div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo8" aria-expanded="true" aria-controls="collapseTwo8" role="button">
																	<span class="svg-icon svg-icon-primary">
																		<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<div class="card">
															...
															<div class="card-header" id="headingThree8">
																<div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree8" aria-expanded="true" aria-controls="collapseThree8" role="button">
																	<span class="svg-icon svg-icon-primary">
																		<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
