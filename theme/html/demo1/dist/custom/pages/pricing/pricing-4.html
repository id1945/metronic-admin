...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Pricing Tables 4 | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Pricing Tables 4</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Pricing Tables 4</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
							...
							<div class="container">
								...
								<div class="card">
									...
									<div class="card-body position-relative p-0 rounded-card-top">
										<!--begin::Pricing title-->
										<h3 class="bg-danger text-white text-center py-10 py-lg-20 m-0 rounded-card-top">Transparent &amp; Simple Pricing</h3>
										<!--end::Pricing title-->
