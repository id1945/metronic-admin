...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Overlay | Keenthemes</title>
		<meta name="description" content="Overlay examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Overlay</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Overlay</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="col-lg-4">
										...
										<div class="card card-custom">
											...
											<div class="card-body">
												...
												<button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#exampleModal">Modal Body Overlay</button>
												<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal2">Entire Modal Overlay</button>
