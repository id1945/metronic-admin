...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Advance Navs | Keenthemes</title>
		<meta name="description" content="Multi-purpose advance navigation examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Advance Navs</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Advance Navigations</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<code>.navi</code>component comes with a variety of options to provide unique looking &amp; multi-purpose naviigations.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.navi</code>to have vertical navigations for inline and dropdown modes.</p>
													<div class="example-preview">
														...
														<div class="dropdown">
															<a href="#" class="btn btn-light-primary font-weight-bold dropdown-toggle" data-toggle="dropdown">Dropdown example</a>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.navi</code>with
													<code>.navi-{light|lighter|bold|bolder|boldest}</code>classes to set font weight.</p>
													<div class="example-preview">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													...
													<code>.navi-footer</code>to have a header and footer.</p>
													<div class="example-preview">
														<ul class="navi">
															<li class="navi-header font-weight-bold py-5">Jump to:
															<i class="flaticon2-information" data-toggle="tooltip" data-placement="right" title="Click to learn more..."></i></li>
															<li class="navi-item">
																<a class="navi-link" href="#">
																	<span class="navi-icon">
																		<i class="flaticon2-chat-1"></i>
														...
														<div class="navi-footer py-5 ml-5 d-flex justify-content-between">
															<a href="#" target="_blank" class="btn btn-light-primary font-weight-bold ml-1">Sign Out</a>
														...
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-md p-0">
																...
																<div class="navi-footer py-5 ml-1 d-flex justify-content-between">
																	<a href="#" target="_blank" class="btn btn-light-primary font-weight-bold ml-5">Sign Out</a>
																	<a href="#" target="_blank" class="btn btn-clean font-weight-bold">Upgrade Plan</a>
																</div>
															</div>
														</div>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													...
													<code>.label</code>component to have label for navigation links.</p>
													<div class="example-preview">
														<ul class="navi">
															<li class="navi-item">
																<a class="navi-link" href="#">
                        ...
                        &lt;/ul&gt;
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.navi-arrow</code>to have navigation links with arrows.</p>
													<div class="example-preview">
														<ul class="navi">
															<li class="navi-item">
																<a class="navi-link" href="#">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													...
													<code>.bullet</code>component navi links with line and dot bullets.</p>
													<div class="example-preview">
														<ul class="navi">
															<li class="navi-item">
																<a class="navi-link" href="#">
                        ...
                        &lt;/ul&gt;
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.navi-section</code>to have section for group of navi links.</p>
													<div class="example-preview">
														<ul class="navi">
															<li class="navi-section text-primary text-uppercase font-weight-bolder pb-0">Section 1</li>
															<li class="navi-item">
																<a class="navi-link" href="#">
																	<span class="navi-icon">
															...
															<li class="navi-section mt-5 text-primary text-uppercase font-weight-bolder pb-0">Section 2</li>
															<li class="navi-item">
																<a class="navi-link" href="#">
																	<span class="navi-icon">
                        ...
                        &lt;/ul&gt;
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.navi-separator</code>to have navi with separators.</p>
													<div class="example-preview">
														<ul class="navi">
															<li class="navi-item">
																<a class="navi-link" href="#">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													...
													<code>.navi-active</code>to have link background color for hover and active states respectively.</p>
													<div class="example-preview">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													...
													<code>.navi-link-rounded-xl</code>classes to have rounded links.</p>
													<div class="example-preview">
                        ...
                        &lt;/ul&gt;
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.navi-accent</code>to have navi link active state with vertical bar ahead.</p>
													<div class="example-preview">
...
<code class="language-html">
                        ...
                        &lt;/ul&gt;
												...
												<div class="example example-basic mt-5">
													<p>Use
													<code>.navi-{color}</code>to change color with bootstrap colors.</p>
													<div class="example-preview">
                        ...
                        &lt;/ul&gt;
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.navi-circle-icon</code>to have navi link active state with vertical bar ahead.</p>
													<div class="example-preview">
														<ul class="navi">
															<li class="navi-item">
																<a class="navi-link" href="#">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													...
													<code>.navi-text</code>to have link with title and description.</p>
													<div class="example-preview">
														<ul class="navi">
															<li class="navi-item">
																<a class="navi-link" href="#">
														...
														<ul class="navi navi-link-rounded navi-hover navi-icon-center navi-active">
															<li class="navi-item">
																<a class="navi-link" href="#">
																	...
																	<span class="navi-label">
																		<span class="label label-light-danger font-weight-bolder label-inline">new</span>
																	</span>
																	<span class="navi-arrow"></span>
																</a>
															</li>
															<li class="navi-item">
																<a class="navi-link" href="#">
																	...
																	<div class="navi-text">
																		<span class="d-block font-weight-bold">New customer has been registered</span>
															...
															<li class="navi-item">
																<a class="navi-link" href="#">
																	...
																	<div class="navi-text">
																		<span class="d-block font-weight-bold">Application has been approved</span>
															...
															<li class="navi-item">
																<a class="navi-link" href="#">
																	...
																	<div class="navi-text">
																		<span class="d-block font-weight-bold">New user feedback has been received</span>
                        ...
                        &lt;/ul&gt;
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.navi-border</code>to have navigation links with border.</p>
													<div class="example-preview">
