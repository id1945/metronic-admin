...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Ribbons | Keenthemes</title>
		<meta name="description" content="Ribbons examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Ribbons</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Ribbons</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<code>.ribbon</code>element enables ribbon style labels on any block component such as card, alerts and container like components.</div>
								</div>
								<!--end::Notice-->
								<!--begin: Row-->
								<div class="row mb-7">
									...
									<div class="col-lg-4">
										...
										<div class="card card-custom">
											<div class="card-header card-header-right ribbon ribbon-clip ribbon-left">
												...
												<span class="ribbon-inner bg-warning"></span>Ribbon</div>
