...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Timeline | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Timeline</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Timeline</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<code>.timeline</code>component comes with a variety of options to provide uniquely looking &amp; multi-purpose Timeline UI.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
													...
													<div class="example-preview">
														...
														<div class="timeline timeline-1">
															...
															<div class="timeline-item">
																...
																<div class="timeline-content text-muted font-weight-normal">Amazon's 'Alexa Answers' is a
																<a href="#" class="text-primary font-weight-bold">hot mess</a>, surprising exactly no one.</div>
															</div>
															<div class="timeline-item">
																...
																<div class="timeline-content text-muted font-weight-normal">Database server overloaded 80% and requires quick reboot.
																<span class="label label-inline label-light-primary font-weight-bolder">new</span></div>
															</div>
															<div class="timeline-item">
																...
																<div class="timeline-content text-muted font-weight-normal">System error occured and hard drive has been shutdown.
																<span class="label label-inline label-light-success font-weight-bolder">pending</span></div>
															</div>
															<div class="timeline-item">
																...
																<div class="timeline-content text-muted font-weight-normal">New order has been placed and pending for processing.</div>
															</div>
															<div class="timeline-item">
																...
																<div class="timeline-content text-muted font-weight-normal">This suite of 50+ apps will replace all your business tools.
																<span class="label label-inline label-light-danger font-weight-bolder">2 pending</span></div>
															</div>
															<div class="timeline-item">
																...
																<div class="timeline-content text-muted font-weight-normal">This app will email you about low airfares so you fly cheap.</div>
															</div>
														</div>
														<!--end::Timeline-->
													</div>
														...
														<div class="timeline timeline-4">
															...
															<div class="timeline-items">
																<div class="timeline-item timeline-item-left">
																	...
																	<div class="timeline-content">Lorem ipsum dolor sit amit,consectetur eiusmdd tempors labore et dolore. Lorem ipsum dolor sit amit.</div>
																</div>
																<div class="timeline-item timeline-item-right">
																	...
																	<div class="timeline-content">Lorem ipsum dolor sit amit,consectetur eiusmdd tempors labore et dolore.</div>
																</div>
																<div class="timeline-item timeline-item-left">
																	<div class="timeline-badge">
																		<div class="bg-danger"></div>
																	...
																	<div class="timeline-content">Lorem ipsum dolor sit amit,consectetur eiusmdd tempors labore et dolore. Lorem ipsum dolor sit amit,consectetur eiusmdd tempors.</div>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="timeline timeline-justified timeline-4">
															...
															<div class="timeline-items">
																<div class="timeline-item">
																	...
																	<div class="timeline-content">Lorem ipsum dolor sit amit,consectetur eiusmdd tempors labore et dolore. Lorem ipsum dolor sit amit,consectetur eiusmdd Lorem ipsum dolor sit amit,consectetur eiusmdd tempors labore et dolore. Lorem ipsum dolor sit amit,consectetur eiusmdd</div>
																</div>
																<div class="timeline-item">
																	<div class="timeline-badge">
																		<div class="bg-success"></div>
