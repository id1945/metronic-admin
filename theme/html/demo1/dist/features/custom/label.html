...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Label | Keenthemes</title>
		<meta name="description" content="Label examples" />
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<code>.font-weight-{lighter|light|normal|bold|bolder|boldest}</code>class.</p>
													<div class="example-preview">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<div class="example-preview">
														...
														<div class="pt-4">
															<p>Dot label style
															<span class="label label-sm label-dot label-success"></span>example</p>
															<p>Dot label style
															<span class="label label-dot label-primary"></span>example</p>
															<p>Dot label style
															<span class="label label-lg label-dot label-danger"></span>example</p>
															<p>Dot label style
															<span class="label label-xl label-dot label-warning"></span>example</p>
														</div>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
