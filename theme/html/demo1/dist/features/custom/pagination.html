...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Pagination | Keenthemes</title>
		<meta name="description" content="Pagination examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Pagination</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Pagination</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.btn</code>and
													<code>form-control</code>to have extended pagination option.</p>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													...
													<code>.btn-hover-{color}</code>classes to pagination color options.</p>
													<div class="example-preview">
														<!--begin::Pagination-->
														<div class="d-flex justify-content-between align-items-center flex-wrap">
															<div class="d-flex flex-wrap py-2 mr-3">
													...
													<div class="example-preview">
														...
														<div class="d-flex justify-content-between align-items-center flex-wrap">
															...
															<div class="d-flex align-items-center py-3">
																...
																<select class="form-control form-control-sm text-success font-weight-bold mr-4 border-0 bg-light-success" style="width: 75px;">
																	<option value="10">10</option>
																	<option value="20">20</option>
																	<option value="30">30</option>
																	<option value="50">50</option>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.btn</code>with
													<code>.btn-sm</code>to have small pagination size.</p>
													<div class="example-preview">
														<!--begin::Pagination-->
														<div class="d-flex justify-content-between align-items-center flex-wrap">
															<div class="d-flex flex-wrap py-2 mr-3">
...
<code class="language-html">
                        ...
                        &lt;/div&gt;
												...
												<div class="example example-basic mt-2">
													<p>Use
													<code>.btn</code>to have default pagination size.</p>
													<div class="example-preview">
														<!--begin::Pagination-->
														<div class="d-flex justify-content-between align-items-center flex-wrap">
															<div class="d-flex flex-wrap py-2 mr-3">
...
<code class="language-html">
                        ...
                        &lt;/div&gt;
												...
												<div class="example example-basic">
													<p>Use
													<code>.btn</code>with
													<code>.btn-lg</code>to have large pagination size.</p>
													<div class="example-preview">
														<!--begin::Pagination-->
														<div class="d-flex justify-content-between align-items-center flex-wrap">
															<div class="d-flex flex-wrap py-2 mr-3">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example example-basic">
													<p>Use
													<code>.btn</code>with
													<code>.btn-circle</code>to have pagination with circle buttons.</p>
													<div class="example-preview">
														<!--begin::Pagination-->
														<div class="d-flex justify-content-between align-items-center flex-wrap">
															<div class="d-flex flex-wrap py-2 mr-3">
																<a href="#" class="btn btn-icon btn-circle btn-sm btn-light-primary mr-2 my-1">
																	<i class="ki ki-bold-double-arrow-back icon-xs"></i>
																</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm btn-light-primary mr-2 my-1">
																	<i class="ki ki-bold-arrow-back icon-xs"></i>
																</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm border-0 btn-hover-primary mr-2 my-1">...</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm border-0 btn-hover-primary mr-2 my-1">23</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm border-0 btn-hover-primary active mr-2 my-1">24</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm border-0 btn-hover-primary mr-2 my-1">25</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm border-0 btn-hover-primary mr-2 my-1">26</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm border-0 btn-hover-primary mr-2 my-1">27</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm border-0 btn-hover-primary mr-2 my-1">28</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm border-0 btn-hover-primary mr-2 my-1">...</a>
																<a href="#" class="btn btn-icon btn-circle btn-sm btn-light-primary mr-2 my-1">
																	<i class="ki ki-bold-arrow-next icon-xs"></i>
																</a>
