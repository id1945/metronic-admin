...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Spinners | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Spinners</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Spinners</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<code>.spinner</code>pseudo element enables spinning effect for any component.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													<p>Add
													<code>.spinner</code>class to any element to have a pseudo spinner.</p>
...
<code class="language-html">
                        &lt;div class="spinner"&gt;&lt;/div&gt;
												...
												<div class="example mb-10">
													<p>Add
													<code>.spinner-track</code>class to to have spinner with track bar.</p>
													<div class="example-preview">
...
<code class="language-html">
                        &lt;div class="spinner"&gt;&lt;/div&gt;
												...
												<div class="example mb-10">
													...
													<code>.spinner-right</code>clases to set spinner aligment.</p>
													<div class="example-preview">
														<div class="mb-10">
...
<code class="language-html">
                        ...
                        &lt;div class="spinner spinner-left"&gt;&lt;/div&gt;
												...
												<div class="example mb-10">
													<p>Add
													<code>.spinner-{color}</code>class to have spinner color options.</p>
													<div class="example-preview">
...
<code class="language-html">
                        ...
                        &lt;div class="spinner spinner-track spinner-dark mr-15"&gt;&lt;/div&gt;
												...
												<div class="example mb-10">
													<p>Add
													<code>.spinner-{sm|lg}</code>classes for spinner size options.</p>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<code>.spinner-left</code>classes.</p>
													<div class="example-preview">
														<button type="button" class="btn btn-primary spinner spinner-white spinner-right mr-3">Primary</button>
														<button type="button" class="btn btn-secondary spinner spinner-dark spinner-right mr-3">Secondary</button>
														<button type="button" class="btn btn-light-success spinner spinner-darker-success spinner-left mr-3">Success</button>
														<button type="button" class="btn btn-outline-danger spinner spinner-darker-danger spinner-left mr-3">Danger</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
...
<code class="language-html">
                        ...
                        &lt;/button&gt;
												...
												<code>KTUtil.btnRelease()</code>utility functions to control button loading state with Javscript. Click to see how the above functions work on the below buttons:</p>
												<!--begin::Example-->
												<div class="example mb-10">
													<div class="example-preview">
                                    ...
                                    KTUtil.addEvent(btn, "click", function() {
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													<p>Use with
													<code>.form-control</code>to add spinner effect to form inputs and set the spinner alignment with
													<code>.spinner-right</code>and
													<code>.spinner-left</code>classes.</p>
													<div class="example-preview">
