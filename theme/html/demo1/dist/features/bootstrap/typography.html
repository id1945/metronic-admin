...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Typography | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Typography</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Typography</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<div class="alert-text">Extended Bootstrap typography, including global settings, headings, body text, lists. For more info lease visit
									<a class="font-weight-bold" href="https://getbootstrap.com/docs/4.6/content/typography/" target="_blank">Bootstrap Typography Documentation</a>.</div>
								</div>
								<!--end::Notice-->
								<div class="row">
									<div class="col-md-6">
       ...
       Duis mollis, est non commodo luctus.&lt;/p&gt;</code>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													<p>Use
													<code>.font-size-{xs|sm|lg|h1|h2|h3|h4|h5|h6}</code>classes to set required font size.</p>
													<div class="example-preview">
...
<code class="language-html">
       ...
       &lt;p class="font-size-h1"&gt;Heading 1 size&lt;/p&gt;
												...
												<div class="example mt-5">
													<p>Use
													<code>.font-size-{xs|sm|lg|xl|xxs}-{|h1|h2|h3|h4|h5|h6|}</code>classes to set responsive font sizes.</p>
													<div class="example-preview">
...
<code class="language-html">
      ...
      &lt;p class="font-size-h5 font-size-lg-h3"&gt;H3 Desktop, H5 Mobile&lt;/p&gt;
												...
												<div class="example mt-5">
													<p>Use
													<code>.display{1|2|3|4}-{xs|sm|lg|xl|xxs}</code>classes to set responsive display texts.</p>
													<div class="example-preview">
      ...
      &lt;p class="display2 display3-lg"&gt;Responve Text 2&lt;/p&gt;
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													<p>Use
													<code>.font-weight-{lighter|light|normal|bold|bolder|boldest}</code>classes to set font weight.</p>
													<div class="example-preview">
       ...
       &lt;a href="#" class="text-warning text-hover-danger"&gt;Link with custom default and hover colors&lt;/a&gt;</code>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-15">
													<p>Use
													<code>.separator</code>custom component to have separator line</p>
													<div class="example-preview">
...
<code class="language-html">
       ...
       &lt;/div&gt;
												...
												<div class="example mb-15">
													<p>Use
													<code>.separator-{border-2|border-3|border-4}</code>classes to set separator sizes.</p>
													<div class="example-preview">
														<div class="mb-10">
...
<code class="language-html">
       ...
       &lt;div class="separator separator-solid separator-border-4"&gt;&lt;/div&gt;
												...
												<div class="example">
													<p>Use
													<code>.separator-{color}</code>classe to set separator colors.</p>
													<div class="example-preview">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-15">
													...
													<code>&lt;blockquote class="blockquote"&gt;</code>around any HTML as the quote.</p>
													<div class="example-preview">
...
<code class="language-html">
       ...
       &lt;/blockquote&gt;</code>
												...
												<div class="example">
													<p>Use
													<code>.text-center</code>to align blockquote to center.</p>
													<div class="example-preview">
