...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Bootstrap Navs | Keenthemes</title>
		<meta name="description" content="Bootstrap navs examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Bootstrap Navs</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Navs</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://getbootstrap.com/docs/4.6/components/navs/" target="_blank">Bootstrap Navs Documentation</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<code>.nav</code>class to the active and disabled states.</p>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													...
													<code>.nav-boldest</code>to set font weight to nav links.</p>
													<div class="example-preview">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<a class="font-weight-bold" href="https://getbootstrap.com/docs/4.6/layout/grid/#horizontal-alignment" target="_blank">flexbox utilities</a>. flexbox utilities. By default, navs are left-aligned, but you can easily change them to center or right aligned.
													<br />Centered with
...
<code class="language-html">
                        ...
                        &lt;/ul&gt;</code>
												...
												<div class="example mb-10">
													...
													<code>.flex-column</code>utility.</p>
													<div class="example-preview">
									...
									<div class="col-xl-6">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													<p>Add the
													<code>.nav-tabs</code>class to generate a tabbed interface. Use them to create tabbable regions with the
													<a class="font-weight-bold" href="https://getbootstrap.com/docs/4.6/components/navs/#javascript-behavior" target="_blank">Tab JavaScript plugin</a>.</p>
													<div class="example-preview">
...
<code class="language-html">
                        ...
                        &lt;/div&gt;</code>
												...
												<div class="example mb-10">
													...
													<code>nav-{color}</code>to change the active pill color.</p>
													<div class="example-preview">
														...
														<div class="tab-content mt-5" id="myTabContent2">
															<div class="tab-pane fade show active" id="home-2" role="tabpanel" aria-labelledby="home-tab-2">Tab content 1</div>
															<div class="tab-pane fade" id="profile-2" role="tabpanel" aria-labelledby="profile-tab-2">Tab content 2</div>
...
<code class="language-html">
                        ...
                        &lt;/div&gt;</code>
												...
												<div class="example mb-10">
													<p>Use the standard bootstrap state color classes
													<code>nav-light-{color}</code>to set the light pill color style.</p>
													<div class="example-preview">
														...
														<div class="tab-content mt-5" id="myTabContent3">
															<div class="tab-pane fade show active" id="home-3" role="tabpanel" aria-labelledby="home-tab-3">Tab content 1</div>
...
<code class="language-html">
                        ...
                        &lt;/div&gt;</code>
												...
												<div class="example mb-10">
													<p>Use
													<code>nav-fill</code>class to fill and justify.</p>
													<div class="example-preview">
														...
														<div class="tab-content mt-5" id="myTabContent4">
															<div class="tab-pane fade show active" id="home-4" role="tabpanel" aria-labelledby="home-tab-4">Tab content 1</div>
															<div class="tab-pane fade" id="profile-4" role="tabpanel" aria-labelledby="profile-tab-4">Tab content 2</div>
															<div class="tab-pane fade" id="contact-4" role="tabpanel" aria-labelledby="contact-tab-4">Tab content 3</div>
														</div>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
...
<code class="language-html">
                        ...
                        &lt;/ul&gt;</code>
												...
												<div class="example mb-10">
													<p>Add Bootstrap's
													<code>.flex-column</code>class for vertical navs.</p>
													<div class="example-preview">
														<div class="row">
															<div class="col-4">
															...
															<div class="col-8">
																<div class="tab-content" id="myTabContent5">
																	<div class="tab-pane fade show active" id="home-5" role="tabpanel" aria-labelledby="home-tab-5">Cillum ad ut irure tempor velit nostrud occaecat ullamco aliqua anim Lorem sint. Id id reprehenderit sit est eu aliqua occaecat quis et velit excepteur laborum mollit dolore eiusmod. Ipsum dolor in occaecat commodo et voluptate minim reprehenderit mollit pariatur.</div>
																	<div class="tab-pane fade" id="profile-5" role="tabpanel" aria-labelledby="profile-tab-5">Cillum ad ut irure tempor velit nostrud occaecat ullamco aliqua anim Lorem sint. Id id reprehenderit sit est eu aliquad. Ipsum dolor in occaecat commodo et voluptate minim reprehenderit mollit pariatur.</div>
																	<div class="tab-pane fade" id="contact-5" role="tabpanel" aria-labelledby="contact-tab-5">Cillum ad ut irure tempor velit nostrud occaecat ullamco aliqua anim Lorem sint. Ipsum dolor in occaecat commodo et voluptate minim reprehenderit mollit pariatur.</div>
																</div>
															</div>
														</div>
													</div>
