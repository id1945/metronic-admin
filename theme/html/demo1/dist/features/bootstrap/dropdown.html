...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Dropdown | Keenthemes</title>
		<meta name="description" content="Dropdown examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Dropdown</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Dropdown</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<code>Bootstrap Dropdown</code>component with a variety of options to provide unique looking Dropdown components that matches Metronic's design standards.
									<br />For more info please visit the plugin's
									<a class="font-weight-bold" href="https://getbootstrap.com/docs/4.6/components/dropdowns/" target="_blank">Bootstrap Documentation</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-15">
													<p>Turn any
													<code>.btn</code>into a dropdown toggle with some markup changes. Here’s how you can put them to work with
													<code>&lt;button&gt;</code>.</p>
                        ...
                        &lt;/div&gt;</code>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												<!--begin::Example-->
												<div class="example">
													<p>Create split button dropdowns with virtually the same markup as single button dropdowns by adding
													<code>.dropdown-toggle-split</code>for proper spacing around the dropdown caret.</p>
													<div class="example-preview">
														<div class="btn-group">
													...
													<div class="example-preview">
														<div class="py-4">
															<div class="btn-toolbar" role="toolbar">
																<div class="btn-group">
																	<button class="btn btn-primary font-weight-bold btn-lg dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Large button</button>
																	<div class="dropdown-menu">
																		<a class="dropdown-item" href="#">Action</a>
																		<a class="dropdown-item" href="#">Another action</a>
																		<a class="dropdown-item" href="#">Something else here</a>
																...
																<div class="btn-group ml-2">
																	<button type="button" class="btn btn-lg btn-light-primary font-weight-bold">Large split button</button>
																	<button type="button" class="btn btn-lg btn-light-primary font-weight-bold dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																		<span class="sr-only">Toggle Dropdown</span>
																	</button>
																	<div class="dropdown-menu">
																		<a class="dropdown-item" href="#">Action</a>
														...
														<div>
															<div class="btn-toolbar" role="toolbar">
																<div class="btn-group">
																	<button class="btn btn-primary font-weight-bold dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Large button</button>
																	<div class="dropdown-menu">
																		<a class="dropdown-item" href="#">Action</a>
																		<a class="dropdown-item" href="#">Another action</a>
																		<a class="dropdown-item" href="#">Something else here</a>
																...
																<!-- /btn-group-->
																<div class="btn-group ml-2">
																	<button type="button" class="btn btn-light-primary font-weight-bold">Large split button</button>
														...
														<div class="py-4">
															<div class="btn-toolbar" role="toolbar">
																<div class="btn-group">
																	<button class="btn btn-primary font-weight-bold btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Small button</button>
																	<div class="dropdown-menu">
																		<a class="dropdown-item" href="#">Action</a>
																		<a class="dropdown-item" href="#">Another action</a>
																		<a class="dropdown-item" href="#">Something else here</a>
																...
																<!-- /btn-group-->
																<div class="btn-group ml-2">
																	<button type="button" class="btn btn-sm btn-light-primary font-weight-bold">Small split button</button>
																	<button type="button" class="btn btn-sm btn-light-primary font-weight-bold dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																		<span class="sr-only">Toggle Dropdown</span>
																	</button>
																	<div class="dropdown-menu">
																		<a class="dropdown-item" href="#">Action</a>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-15">
													...
													<code>.dropup</code>to the parent element.</p>
													<div class="example-preview">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													...
													<div class="example-preview">
														<div class="btn-group">
															<button class="btn btn-primary font-weight-bold btn-lg dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Form example</button>
										...
										<div class="card card-custom">
											...
											<div class="card-body">
												...
												<div class="example">
													...
													<code>data-reference</code>to change the location of the dropdown.</p>
													<div class="example-preview">
														<div class="d-flex">
															<div class="dropdown mr-1">
																<button type="button" class="btn btn-outline-secondary dropdown-toggle" id="dropdownMenuOffset" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-offset="10,20">Offset</button>
