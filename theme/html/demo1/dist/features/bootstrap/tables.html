							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Tables</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://getbootstrap.com/docs/4.6/content/tables/" target="_blank">Bootstrap Documentation</a>.</div>
								</div>
								<!--end::Notice-->
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<code>.thead-dark</code>to make &lt;thead&gt;s appear light or dark gray.</p>
													<div class="example-preview">
                        ...
                        &lt;/table&gt;</code>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													<p>Use
													<code>.table-striped</code>to add zebra-striping to any table row within the &lt;tbody&gt;.</p>
													<div class="example-preview">
                        ...
                        &lt;/table&gt;</code>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													<p>Add
													<code>.table-bordered</code>for borders on all sides of the table and cells.</p>
													<div class="example-preview">
                        ...
                        &lt;/table&gt;</code>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													<p>Add
													<code>.table-borderless</code>for a table without borders.</p>
													<div class="example-preview">
									...
									<div class="col-xl-6">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													<p>Add
													<code>.table-hover</code>for a table with hover effect.</p>
													<div class="example-preview">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<code>.table-responsive{-sm|-md|-lg|-xl}</code>.</p>
													<div class="example-preview">
...
<code class="language-html">
                        ...
                        &lt;/div&gt;</code>
												...
												<div class="example mb-10">
													<p>Use
													<code>.table-responsive{-sm|-md|-lg|-xl}</code>as needed to create responsive tables up to a particular breakpoint. From that breakpoint and up, the table will behave normally and not scroll horizontally.</p>
													<div class="example-preview">
