...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Progress | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Progress</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<code>Bootstrap Progress</code>component with a variety of options to provide unique looking Progress components that matches Metronic's design standards.
									<br />For more info on Bootstrap Progress please visit the official
									<a class="font-weight-bold" href="https://getbootstrap.com/docs/4.6/components/progress/" target="_blank">Bootstrap Documentation</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												<!--begin::Example-->
												<div class="example">
													<p>Bootstrap Progress components are built with two HTML elements, some CSS to set the width, and a few attributes.</p>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													...
													<code>.progress-bar</code>will automatically resize.</p>
													<div class="example-preview">
														<div class="pt-4">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													...
													<code>.progress-bar</code>to apply a stripe via CSS gradient over the progress bar’s background color.</p>
													<div class="example-preview">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													...
													<code>.progress-bar</code>to animate the stripes right to left via CSS3 animations.</p>
													<div class="example-preview">
														<div class="progress mb-3">
