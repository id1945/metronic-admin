							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Alerts</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Alerts</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<code>Bootstrap Alert</code>component with a variety of options to provide unique looking Alert components that matches Metronic's design standards.
									<br />For more info please visit Bootstrap Alert's
									<a class="font-weight-bold" href="https://getbootstrap.com/docs/4.6/components/alerts/" target="_blank">Bootstrap Documentation</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
                        ...
                        &lt;/div&gt; </code>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													<p>Use the
													<code>.alert-link</code>utility class to quickly provide matching colored links within any alert.</p>
													<div class="example-preview">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													<p>Use
													<code>alert-outline-{color}</code>to have outline styled alerts.</p>
													<div class="example-preview">
...
<code class="language-html">
                        ...
                        &lt;/div&gt;</code>
												...
												<div class="example">
													<p>Use
													<code>alert-outline-2</code>to increase the border width.</p>
													<div class="example-preview">
                        ...
                        &lt;/div&gt;</code>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													<p>Use
													<code>alert-light-{color}</code>to have light style alerts.</p>
													<div class="example-preview">
                        ...
                        &lt;/div&gt;</code>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													<p>Use
													<code>alert-notice alert-light-{color}</code>to have notice styled alerts.</p>
													<div class="example-preview">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													...
													<code>.shadow-lg</code>classes can be used to adjust the shadow size.</p>
													<div class="example-preview">
