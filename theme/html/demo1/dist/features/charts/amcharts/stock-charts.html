...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>AmCharts Stock Charts | Keenthemes</title>
		<meta name="description" content="Amcharts stock charts examples" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">amCharts Stock Charts</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">amCharts</a>
											</li>
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">amCharts Stock Charts</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<div class="alert-text">
										...
										<b>amCharts</b>for free. The only limitation of the free version is that a small link to this web site will be displayed in the top left corner of your charts. If you would like to use charts without this link, or you appreciate the software and would like to support its creators,
										<a class="font-weight-bold" href="http://www.amcharts.com/online-store/" target="_blank">please purchase a commercial license</a></p>
										<p>
										<span class="label label-danger label-inline">Exclusively for Metronic users:</span>
										<br />After purchasing
										<b>Metronic</b>you will get a promo code for
										<span class="label label-primary label-border label-inline label-rounded">15% DISCOUNT</span>for the commercial license of
										<b>amChart</b>. To find the promo code please check the README file in the Metronic's purchased package.</p>
										<p>For more info please check
										<a class="font-weight-bold" href="http://www.amcharts.com/demos/" target="_blank">Amcharts Home</a>.</p>
									</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
		...
		<script src="assets/js/pages/features/charts/amcharts/stock-charts.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>