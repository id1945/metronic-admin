...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Kanban Board | Keenthemes</title>
		<meta name="description" content="Pure agnostic Javascript plugin for Kanban boards" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Kanban Board</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Kanban Board</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="http://www.riccardotartaglia.it/jkanban/" target="_blank">Kanban Home</a>or
									<a class="font-weight-bold" href="https://github.com/riktar/jkanban" target="_blank">Kanban GitHub Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
