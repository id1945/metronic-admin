...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Bootstrap Notify | Keenthemes</title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Bootstrap Notify</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Bootstrap Notify</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://github.com/mouse0270/bootstrap-notify/" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
									...
									<form>
										<div class="card-body">
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<input data-switch="true" type="checkbox" checked="checked" data-on-color="brand" id="kt_notify_dismiss" />
												</div>
											</div>
											<div class="form-group row">
		...
		<script src="assets/js/pages/features/miscellaneous/bootstrap-notify.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>