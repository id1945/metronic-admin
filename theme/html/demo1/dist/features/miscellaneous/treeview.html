...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Treeview | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Treeview</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Tree View</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://github.com/vakata/jstree" target="_blank">jsTree's Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
										...
										<div class="card card-custom example example-compact gutter-b">
											...
											<div class="card-body">
												...
												<div class="alert alert-custom alert-light-primary font-weight-bold my-10">
													<div class="alert-text">Note! Opened and selected nodes will be saved in the user's browser, so when returning to the same tree the previous state will be restored.</div>
												</div>
												<!--begin::Code example-->
										...
										<div class="card card-custom example example-compact gutter-b">
											...
											<div class="card-body">
												...
												<div class="alert alert-custom alert-light-primary my-10">
													<div class="alert-text">Note! The tree nodes are loaded from server side demo script via ajax.</div>
												</div>
												<!--begin::Code example-->
												<div class="example-code">
													<ul class="example-nav nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-2x">
