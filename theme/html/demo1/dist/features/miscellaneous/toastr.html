							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Toastr</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Toastr</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://github.com/CodeSeven/toastr" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
											...
											<div class="row">
												<div class="col-lg-4">
													...
													<div class="form-group">
														<div class="checkbox-list">
															...
															<span class="ml-3"></span>Close Button</label>
															<label class="checkbox">
															<input id="addBehaviorOnToastClick" type="checkbox" value="checked" />
															<span class="ml-3"></span>Add behavior on toast click</label>
															<label class="checkbox">
															<input id="debugInfo" type="checkbox" value="checked" />
															<span class="ml-3"></span>Debug</label>
															<label class="checkbox">
															<input id="progressBar" type="checkbox" value="checked" />
															<span class="ml-3"></span>Progress Bar</label>
															<label class="checkbox">
															<input id="preventDuplicates" type="checkbox" value="checked" />
															<span class="ml-3"></span>Prevent Duplicates</label>
															<label class="checkbox">
															<input id="addClear" type="checkbox" value="checked" />
															<span class="ml-3"></span>Add button to force clearing a toast, ignoring focus</label>
															<label class="checkbox">
															<input id="newestOnTop" type="checkbox" value="checked" />
															<span class="ml-3"></span>Newest on top</label>
														</div>
													</div>
												</div>
												<div class="col-lg-2">
													<div class="form-group">
														...
														<div class="radio-list" id="toastTypeGroup">
															<label class="radio">
															<input type="radio" name="toasts" checked="checked" value="success" />
															<span class="ml-3"></span>Success</label>
															<label class="radio">
															<input type="radio" name="toasts" value="info" />
															<span class="ml-3"></span>Info</label>
															<label class="radio">
															<input type="radio" name="toasts" value="warning" />
															<span class="ml-3"></span>Warning</label>
															<label class="radio">
															<input type="radio" name="toasts" value="error" />
															<span class="ml-3"></span>Error</label>
														</div>
													</div>
													<div class="form-group">
												...
												<div class="col-lg-2">
													...
													<div class="form-group">
														...
														<a href="http://www.gsgd.co.uk/sandbox/jquery/easing/" target="_blank" class="font-weight-bold">See all show options</a>
													</div>
													<div class="form-group">
														...
														<a href="http://www.gsgd.co.uk/sandbox/jquery/easing/" target="_blank" class="font-weight-bold">See all hide options</a>
													</div>
												</div>
												<div class="col-lg-2">
													<div class="form-group">
										...
										<div class="card-footer">
											<div class="row">
												<div class="col-lg-8 offset-lg-4">
													...
													<a href="javascript:;" class="btn btn-light-primary font-weight-bold" id="cleartoasts">Clear Toasts</a>
													<a href="javascript:;" class="btn btn-light-primary font-weight-bold" id="clearlasttoast">Clear Last Toast</a>
												</div>
											</div>
										</div>
									</form>
