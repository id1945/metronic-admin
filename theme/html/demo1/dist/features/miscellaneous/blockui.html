...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>BlockUI | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">BlockUI</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Block UI</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<div class="alert-text">The jQuery BlockUI Plugin lets you simulate synchronous behavior when using AJAX, without locking the browser.
									...
									<a class="font-weight-bold" href="https://github.com/malsup/blockui/" target="_blank">StickyJS Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<div class="card-body">
												...
												<div class="mt-5">
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_default">Default</button>
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_overlay_color">Overlay color</button>
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_custom_spinner">Custom spinner</button>
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_custom_text_1">Custom text 1</button>
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_custom_text_2">Custom text 2</button>
												</div>
												<!--begin::Code example-->
         ...
         KTApp.unblock('#kt_blockui_content');
										...
										<div class="card card-custom example example-compact">
											...
											<div class="card-body">
												...
												<div class="mt-5">
													<button type="button" class="btn btn-light font-weight-bold" data-toggle="modal" data-target="#kt_blockui_modal_default">Default</button>
													<button type="button" class="btn btn-light font-weight-bold" data-toggle="modal" data-target="#kt_blockui_modal_overlay_color">Overlay color</button>
													<button type="button" class="btn btn-light font-weight-bold" data-toggle="modal" data-target="#kt_blockui_modal_custom_spinner">Custom spinner</button>
													<button type="button" class="btn btn-light font-weight-bold" data-toggle="modal" data-target="#kt_blockui_modal_custom_text_1">Custom text 1</button>
													<button type="button" class="btn btn-light font-weight-bold" data-toggle="modal" data-target="#kt_blockui_modal_custom_text_2">Custom text 2</button>
												</div>
												<!--end::Preview-->
												<!--begin::Code example-->
												<div class="example-code mt-7">
									...
									<div class="col-xl-6">
										...
										<div class="card card-custom gutter-b example example-compact" id="kt_blockui_card">
											...
											<div class="card-body">
												...
												<div class="mt-5">
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_card_default">Default</button>
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_card_overlay_color">Overlay color</button>
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_card_custom_spinner">Custom spinner</button>
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_card_custom_text_1">Custom text 1</button>
													<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_card_custom_text_2">Custom text 2</button>
												</div>
												<!--begin::Code example-->
												<div class="example-code mt-7">
													<ul class="example-nav nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-2x">
										...
										<div class="card card-custom example example-compact">
											...
											<div class="card-body">
												...
												<div class="example example-basic mb-5">
													...
													<div class="mt-5">
														<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_page_default">Default</button>
														<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_page_overlay_color">Overlay color</button>
														<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_page_custom_spinner">Custom spinner</button>
														<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_page_custom_text_1">Custom text 1</button>
														<button type="button" class="btn btn-light font-weight-bold" id="kt_blockui_page_custom_text_2">Custom text 2</button>
													</div>
													<!--end::Preview-->
												</div>
												<!--end::Example-->
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<button type="button" class="btn btn-primary" id="kt_blockui_modal_default_btn">Block modal</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="modal fade" id="kt_blockui_modal_overlay_color" tabindex="-1" role="dialog" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
												<button type="button" class="btn btn-primary" id="kt_blockui_modal_overlay_color_btn">Block modal</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="modal fade" id="kt_blockui_modal_custom_spinner" tabindex="-1" role="dialog" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
												<button type="button" class="btn btn-primary" id="kt_blockui_modal_custom_spinner_btn">Block modal</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="modal fade" id="kt_blockui_modal_custom_text_1" tabindex="-1" role="dialog" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
												<button type="button" class="btn btn-primary" id="kt_blockui_modal_custom_text_1_btn">Block modal</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="modal fade" id="kt_blockui_modal_custom_text_2" tabindex="-1" role="dialog" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
												<button type="button" class="btn btn-primary" id="kt_blockui_modal_custom_text_2_btn">Block modal</button>
											</div>
										</div>
									</div>
								</div>
