...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>SweetAlert2 | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">SweetAlert2</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">SweetAlert2</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<div class="alert-text">A beautiful, responsive, customizable, accessible (wai-aria) replacement for javascript's popup boxes.
									...
									<a class="font-weight-bold" href="https://github.com/sweetalert2/sweetalert2" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin: Row-->
								<div class="row">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_1">Show me</button>
													</div>
                        ...
                        $("#kt_sweetalert_demo_1").click(function(e) {
                            Swal.fire("Good job!");
												...
												<div class="example mb-10">
													...
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_2">Show me</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="example">
													...
													<code>success</code>,
													<code>info</code>and
													<code>question</code>state icons</p>
													<div class="example-preview">
														<button type="button" class="btn btn-light-warning font-weight-bold" id="kt_sweetalert_demo_3_1">Warning</button>
														<button type="button" class="btn btn-light-danger font-weight-bold" id="kt_sweetalert_demo_3_2">Error</button>
														<button type="button" class="btn btn-light-success font-weight-bold" id="kt_sweetalert_demo_3_3">Success</button>
														<button type="button" class="btn btn-light-info font-weight-bold" id="kt_sweetalert_demo_3_4">Info</button>
														<button type="button" class="btn btn-light-dark font-weight-bold" id="kt_sweetalert_demo_3_5">Question</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
										...
										<div class="card card-custom">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_4">Show me</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
        ...
        customClass: {
         confirmButton: "btn btn-primary"
												...
												<div class="example mb-10">
													...
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_5">Show me</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
        ...
        customClass: {
         ...
         cancelButton: "btn btn-default"
												...
												<div class="example mb-10">
													...
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_6">Show me</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
										...
										<div class="card card-custom">
											...
											<div class="card-body">
												...
												<div class="example mb-10">
													...
													<a href="https://animate.style/" target="_blank" class="mr-2">animate.css</a>animation.</p>
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_7">Show me</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
          ...
          hideClass: {
            popup: 'animate__animated animate__fadeOutUp'
												...
												<div class="example mb-10">
													...
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_8">Show me</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
                                    ...
                                    Swal.fire(
                                        ...
                                        "success"
												...
												<div class="example mb-10">
													...
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_9">Show me</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
                                    ...
                                    Swal.fire(
                                        ...
                                        "error"
												...
												<div class="example mb-10">
													...
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_10">Show me</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
                            ...
                            Swal.fire({
                                ...
                                animation: false
												...
												<div class="example">
													...
													<div class="example-preview">
														<button type="button" class="btn btn-light-primary font-weight-bold" id="kt_sweetalert_demo_11">Show me</button>
													</div>
													<div class="example-code">
														<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
														<div class="example-highlight">
