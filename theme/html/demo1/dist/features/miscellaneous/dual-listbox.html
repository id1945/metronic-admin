...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Dual Listbox Dashboard | Keenthemes</title>
		<meta name="description" content="Dual litbox examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Dual Listbox Dashboard</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Dual Listbox</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<div class="alert-text">Dual Listbox is a pure JavaScript plugin that converts the normal select box into a searchable dual list box where the users are able to move options between two selection panels.
									<br />For more info please visit the plugin's
									<a class="font-weight-bold" href="https://www.cssscript.com/demo/pure-js-dual-list-box-component/" target="_blank">Demo Page</a>or
									<a class="font-weight-bold" href="https://github.com/maykinmedia/dual-listbox" target="_blank">GitHub</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin: Row-->
								<div class="row">
