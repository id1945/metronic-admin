...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Perfect Scrollbar | Keenthemes</title>
		<meta name="description" content="Perfect scrollbar examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Perfect Scrollbar</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Perfect Scrollbar</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<div class="alert-text">Perfect Scrollbar - Minimalistic but perfect custom scrollbar plugin. For more info please visit
									<a class="font-weight-bold" href="https://github.com/mdbootstrap/perfect-scrollbar" target="_blank">Perfect Scrollbar's Github</a>.
									<br />Use any plugin option from
									<a class="font-weight-bold mr-2" href="https://github.com/mdbootstrap/perfect-scrollbar#options">Perfect Scrollbar Options</a>through HTML attribure, for example
									<code>data-wheel-propagation="true"</code>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Row-->
								<div class="row">
      ...
      &lt;/div&gt;
										...
										<div class="card card-custom example example-compact gutter-b">
											...
											<div class="card-body">
												...
												<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#kt_scrollable_modal_1">Launch Modal</button>
												<!--begin: Example code-->
												<div class="example-code mt-10">
													<div class="example-highlight">
														<pre>
