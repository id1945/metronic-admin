...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Base Table Widgets | Keenthemes</title>
		<meta name="description" content="Base table widget examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Base Table Widgets</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Base Tables</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
											...
											<div class="card-header border-0 mt-5">
												...
												<div class="card-toolbar">
													<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Quick actions">
														<a href="#" class="btn btn-light-danger btn-sm font-weight-bold font-size-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dashboard</a>
													...
													<table class="table table-borderless table-vertical-center">
														...
														<tbody>
															<tr>
																...
																<td class="pl-0">
																	<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Special Meal</a>
																...
																<td class="text-right pr-0">
																	...
																	<span class="text-dark-75 font-weight-bolder d-block font-size-lg">$600.00</span>
																</td>
															</tr>
															<tr>
																<td class="pl-0">
																...
																<td class="pl-0">
																	<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Orange Wholesale</a>
																...
																<td class="text-right">
																	<span class="text-muted font-weight-bold d-block">Paid</span>
																	<span class="text-dark-75 font-weight-bolder d-block font-size-lg">$32.00</span>
																</td>
																<td class="text-right pr-0">
																	<span class="text-muted font-weight-bold d-block">Price</span>
																	<span class="text-dark-75 font-weight-bolder d-block font-size-lg">$6400.00</span>
																</td>
															</tr>
															<tr>
																<td class="pl-0">
																...
																<td class="pl-0">
																	<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Avocado Box</a>
															...
															<tr>
																...
																<td class="pl-0">
																	<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Spinach Juices</a>
																	<span class="text-muted font-weight-bold d-block">Successful Fellas</span>
																</td>
																<td class="pr-0 align-items-center text-right">
																	<span class="mr-1">
															...
															<tr>
																<td class="pl-0">
																	<div class="symbol symbol-50 symbol-fixed mr-2 mt-2">
																		<div class="symbol-label" style="background-image: url('assets/media/stock-600x400/img-7.jpg')"></div>
																	</div>
																</td>
																<td class="pl-0">
																	<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Strawberry Boxes</a>
																	<span class="text-muted font-weight-bold d-block">From Spain</span>
																</td>
																<td class="pr-0 align-items-center text-right">
																	<span class="mr-1">
																...
																<td class="text-right pr-0">
																	<span class="text-muted font-weight-bold d-block">Price</span>
																	<span class="text-dark-75 font-weight-bolder d-block font-size-lg">$750.00</span>
																</td>
															</tr>
														</tbody>
													</table>
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 pt-5">
												...
												<div class="card-toolbar">
													<ul class="nav nav-pills nav-pills-sm nav-dark-75">
														...
														<li class="nav-item">
															<a class="nav-link py-2 px-4 active" data-toggle="tab" href="#kt_tab_pane_8_3">Day</a>
														</li>
													</ul>
												</div>
											</div>
											...
											<div class="card-body pt-2 pb-0 mt-n3">
												<div class="tab-content mt-5" id="myTabTables8">
													<!--begin::Tap pane-->
													<div class="tab-pane fade" id="kt_tab_pane_8_1" role="tabpanel" aria-labelledby="kt_tab_pane_8_1">
														<!--begin::Table-->
														<div class="table-responsive">
															<table class="table table-borderless table-vertical-center">
																<thead>
																...
																<tbody>
																	<tr>
																		<td class="pl-0">
																			<div class="symbol symbol-35 symbol-circle symbol-light-success mr-2 mt-1">
																				<span class="symbol-label">
																					<span class="svg-icon svg-icon-2x svg-icon-success">
																		...
																		<td class="pl-0">
																			<a href="#" class="text-dark font-weight-bolder text-hover-primary d-block my-1 font-size-lg">K-Pax</a>
																			<span class="text-muted font-weight-bold">Man of No Ego</span>
																		</td>
																		<td class="text-right">
																			<span class="text-muted font-weight-bold mt-2 d-block font-size-xs">Created</span>
																			<span class="text-dark-75 font-weight-bold">1 week ago</span>
																		</td>
																		<td class="text-right">
																			<span class="font-weight-bolder text-primary mt-4 d-block">03.09</span>
																		</td>
																		<td class="text-right pr-0">
																			<a href="#" class="btn btn-hover-light-success btn-sm btn-icon mt-4">
																	...
																	<tr>
																		...
																		<td class="pl-0">
																			<a href="#" class="text-dark font-weight-bolder text-hover-primary d-block my-1 font-size-lg">Surrender</a>
																		...
																		<td class="text-right">
																			<span class="font-weight-bolder text-primary mt-4 d-block">02.54</span>
																		</td>
																		<td class="text-right pr-0">
																			<a href="#" class="btn btn-hover-light-success btn-sm btn-icon mt-4">
																				<i class="ki ki-bold-more-hor"></i>
																	...
																	<tr>
																		...
																		<td class="pl-0">
																			<a href="#" class="text-dark font-weight-bolder text-hover-primary d-block my-1 font-size-lg">The Boy With the Bubbleg..</a>
																		...
																		<td class="text-right">
																			<span class="font-weight-bolder text-primary mt-4 d-block">03.46</span>
																		</td>
																		<td class="text-right pr-0">
																			<a href="#" class="btn btn-hover-light-success btn-sm btn-icon mt-4">
																				<i class="ki ki-bold-more-hor"></i>
																	...
																	<tr>
																		...
																		<td class="pl-0">
																			<a href="#" class="text-dark font-weight-bolder text-hover-primary d-block my-1 font-size-lg">Best Rated Songs</a>
																		...
																		<td class="text-right">
																			<span class="font-weight-bolder text-primary mt-4 d-block">02.46</span>
																		</td>
																		<td class="text-right pr-0">
																			<a href="#" class="btn btn-hover-light-success btn-sm btn-icon mt-4">
																				<i class="ki ki-bold-more-hor"></i>
																	...
																	<tr>
																		...
																		<td class="pl-0">
																			<a href="#" class="text-dark font-weight-bolder text-hover-primary d-block my-1 font-size-lg">Pray the Light</a>
																		...
																		<td class="text-right">
																			<span class="font-weight-bolder text-primary mt-4 d-block">04.20</span>
																		</td>
																		<td class="text-right pr-0">
																			<a href="#" class="btn btn-hover-light-success btn-sm btn-icon mt-4">
																				<i class="ki ki-bold-more-hor"></i>
																	...
																	<tr>
																		...
																		<td class="pl-0">
																			<a href="#" class="text-dark font-weight-bolder text-hover-primary d-block my-1 font-size-lg">Ocean Drive</a>
																		...
																		<td class="text-right">
																			<span class="font-weight-bolder text-primary mt-4 d-block">05.38</span>
																		</td>
																		<td class="text-right pr-0">
																			<a href="#" class="btn btn-hover-light-success btn-sm btn-icon mt-4">
																				<i class="ki ki-bold-more-hor"></i>
													...
													<!--end::Tap pane-->
													<!--begin::Tap pane-->
													<div class="tab-pane fade" id="kt_tab_pane_8_2" role="tabpanel" aria-labelledby="kt_tab_pane_8_2">
														<!--begin::Table-->
														<div class="table-responsive">
															<table class="table table-borderless table-vertical-center">
																<thead>
													...
													<!--end::Tap pane-->
													<!--begin::Tap pane-->
													<div class="tab-pane fade show active" id="kt_tab_pane_8_3" role="tabpanel" aria-labelledby="kt_tab_pane_8_3">
														<!--begin::Table-->
														<div class="table-responsive">
															<table class="table table-borderless table-vertical-center">
																<thead>
