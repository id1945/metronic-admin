...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>List Widgets | Keenthemes</title>
		<meta name="description" content="List style widget examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">List Widgets</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="col-xl-4">
										...
										<div class="card card-custom bg-light-success card-stretch gutter-b">
											...
											<div class="card-header border-0">
												...
												<div class="card-toolbar">
													<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Quick actions">
														<a href="#" class="btn btn-success btn-sm font-weight-normal font-size-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Create</a>
														<div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
															<!--begin::Naviigation-->
															<ul class="navi">
																<li class="navi-header font-weight-bold py-5">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body pt-2">
												...
												<div class="d-flex align-items-center mb-10">
													...
													<div class="d-flex flex-column flex-grow-1">
														<!--begin::Title-->
														<a href="#" class="text-dark font-weight-bolder font-size-lg text-hover-primary mb-1">Cup &amp; Green</a>
														<!--end::Title-->
														<!--begin::Desc-->
														<span class="text-dark-50 font-weight-normal font-size-sm">Coffee is a brewed drink prepared from roasted coffee beans.
												...
												<div class="d-flex align-items-center mb-10">
													...
													<div class="d-flex flex-column flex-grow-1">
														<!--begin::Title-->
														<a href="#" class="text-dark font-weight-bolder text-hover-primary font-size-lg mb-1">Yellow Background</a>
														<!--end::Title-->
														<!--begin::Desc-->
														<span class="text-dark-50 font-weight-normal font-size-sm">Yellow is the color between orange and green on the spectrum of light.
												...
												<div class="d-flex align-items-center mb-10">
													...
													<div class="d-flex flex-column flex-grow-1">
														<!--begin::Title-->
														<a href="#" class="text-dark font-weight-bolder text-hover-primary font-size-lg mb-1">Nike &amp; Blue</a>
														<!--end::Title-->
														<!--begin::Desc-->
														<span class="text-dark-50 font-weight-normal font-size-sm">Engaged in the design, development, manufacturing, and marketing
												...
												<div class="d-flex align-items-center">
													...
													<div class="d-flex flex-column flex-grow-1">
														<!--begin::Title-->
														<a href="#" class="text-dark font-weight-bolder text-hover-primary font-size-lg mb-1">Red Boots</a>
														<!--end::Title-->
														<!--begin::Desc-->
														<span class="text-dark-50 font-weight-normal font-size-sm">Boots have a heel that is clearly distinguishable from the rest of the sole
