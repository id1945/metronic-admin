...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Engage Widgets | Keenthemes</title>
							...
							<div class="container">
								...
								<div class="row">
									<div class="col-xl-4">
										...
										<div class="card card-custom card-stretch gutter-b">
											<div class="card-body d-flex p-0">
												<div class="flex-grow-1 bg-light-success p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.5rem) bottom; background-size: 35% auto; background-image: url(assets/media/svg/humans/custom-5.svg)">
									...
									<div class="col-xl-4">
										...
										<div class="card card-custom card-stretch gutter-b">
											<div class="card-body d-flex p-0">
												<div class="flex-grow-1 bg-danger p-12 pb-40 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.5rem) bottom; background-size: 35% auto; background-image: url(assets/media/svg/humans/custom-7.svg)">
								...
								<div class="row">
									...
									<div class="col-xl-6">
										...
										<div class="card card-custom card-stretch gutter-b">
											<div class="card-body d-flex p-0">
												<div class="flex-grow-1 p-20 pb-40 bg-warning card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.5rem) bottom; background-size: 50% auto; background-image: url(assets/media/svg/humans/custom-10.svg)">
									...
									<div class="col-xl-6">
										...
										<div class="card card-custom card-stretch card-stretch-half gutter-b overflow-hidden">
											<div class="card-body p-0 d-flex rounded bg-light-danger">
												...
												<div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-cover" style="transform: scale(1.5) rotate(-26deg); background-image: url('assets/media/products/12.png')"></div>
											</div>
										</div>
										<!--end::Engage Widget 12-->
									</div>
													...
													<div class="col-xxl-5 mb-11 mb-xxl-0">
														...
														<div class="card card-custom card-stretch">
															<div class="card-body p-0 rounded px-10 py-15 d-flex align-items-center justify-content-center" style="background-color: #FFCC69;">
																<img src="assets/media/products/21.png" class="mw-100 w-200px" style="transform: scale(1.6);" />
															</div>
														</div>
														<!--end::Image-->
													</div>
