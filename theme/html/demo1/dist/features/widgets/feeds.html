...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Feeds Widgets | Keenthemes</title>
		<meta name="description" content="Feeds widget examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Feeds Widgets</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Feeds</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
										...
										<div class="card card-custom bg-light gutter-b">
											...
											<div class="card-body pt-2">
												...
												<form class="form" id="kt_form_1">
													...
													<div class="form-group">
														<textarea class="form-control border-0" name="memo" rows="4" placeholder="Message" id="kt_forms_widget_1_input"></textarea>
													</div>
													<div class="mt-10">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center">
													...
													<!--begin::Info-->
													<div class="d-flex flex-column flex-grow-1">
														<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">WWII Quiz Pt 2</a>
														<div class="d-flex">
															<div class="d-flex align-items-center pr-5">
																<span class="svg-icon svg-icon-md svg-icon-primary pr-1">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/Home/Clock.svg-->
												...
												<div class="pt-3">
													<!--begin::Text-->
													<p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-7">Outlines keep you honest. They stop you from indulging in poorly thought-out metaphors</p>
													<!--end::Text-->
													<!--begin::Video-->
												...
												<!--begin::Editor-->
												<form class="position-relative">
													<textarea id="kt_forms_widget_9_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1" placeholder="Any Question?"></textarea>
													<div class="position-absolute top-0 right-0 mt-n1 mr-n2">
														<span class="btn btn-icon btn-sm btn-hover-icon-primary">
															<i class="flaticon2-clip-symbol icon-ms"></i>
														</span>
									...
									<div class="col-xl-6 col-sm-12">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="pt-3">
													<!--begin::Text-->
													<p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-6">Outlines keep you honest. They stop you from indulging in poorly thought-out metaphors about driving and keep you focused on the overall structure of your post</p>
													<!--end::Text-->
													<!--begin::Username-->
												...
												<!--begin::Editor-->
												<form class="position-relative">
													<textarea id="kt_forms_widget_10_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1" placeholder="Any Question?"></textarea>
													<div class="position-absolute top-0 right-0 mt-n1 mr-n2">
														<span class="btn btn-icon btn-sm btn-hover-icon-primary">
															<i class="flaticon2-clip-symbol icon-ms"></i>
														</span>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<div class="pt-3">
													<!--begin::Text-->
													<p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-6">Outlines keep you honest. They stop you from indulging in poorly thought-out metaphors</p>
													<!--end::Text-->
													<!--begin::Image-->
