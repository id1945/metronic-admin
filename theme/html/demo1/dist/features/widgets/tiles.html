...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Tiles Widgets | Keenthemes</title>
		<meta name="description" content="Tiles widget examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Tiles Widgets</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Tiles</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
											...
											<div class="card-body d-flex flex-column p-0">
												...
												<div class="flex-grow-1 card-spacer">
													...
													<div class="d-flex align-items-center justify-content-between">
														...
														<div class="label label-light label-inline font-weight-bold text-dark-50 py-4 px-3 font-size-base">+280$</div>
													</div>
													<!--end::Item-->
												</div>
												<!--end::Items-->
												<!--begin::Chart-->
												<div id="kt_tiles_widget_8_chart" class="card-rounded-bottom" data-color="danger" style="height: 150px"></div>
												<!--end::Chart-->
											</div>
											<!--end::Body-->
										</div>
									...
									<div class="col-xl-8">
										<div class="row">
											<div class="col-xl-3">
												...
												<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="height: 150px; background-image: url(assets/media/stock-600x400/img-26.jpg)">
													<!--begin::Body-->
													<div class="card-body d-flex flex-column">
														<!--begin::Title-->
														<a href="#" class="text-white text-hover-primary font-weight-bolder font-size-h3">Projects</a>
														<!--end::Title-->
													</div>
													<!--end::Body-->
												</div>
									...
									<div class="col-xl-8">
										<div class="row">
											<div class="col-xl-4">
												...
												<div class="card card-custom bgi-no-repeat gutter-b" style="height: 300px; background-color: #663259; background-position: calc(100% + 0.5rem) calc(100% + 0.5rem); background-size: 105% auto; background-image: url(assets/media/svg/patterns/aare.svg)">
													<!--begin::Body-->
													<div class="card-body">
														<a href="#" class="text-white font-weight-bolder line-height-lg mb-5 font-size-h3">Create Reports
														<br />With SaaS</a>
													</div>
													<!--end::Body-->
												</div>
											...
											<div class="col-xl-4">
												...
												<div class="card card-custom gutter-b" style="height: 300px;">
													...
													<div class="card-body d-flex flex-column p-0">
														...
														<!--end::Stats-->
														<!--begin::Chart-->
														<div id="kt_tiles_widget_17_chart" class="card-rounded-bottom" style="height: 150px"></div>
														<!--end::Chart-->
													</div>
													<!--end::Body-->
												</div>
											...
											<div class="col-xl-4">
												...
												<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="height: 300px; background-image: url(assets/media/stock-600x600/img-15.jpg)">
													<!--begin::Body-->
													<div class="card-body">
														<a href='#' class="btn btn-link btn-link-dark-75 font-weight-bold font-size-h5">Latest Products
											...
											<div class="col-xl-8">
												...
												<div class="card card-custom bgi-no-repeat gutter-b" style="height: 250px; background-color: #1B283F; background-position: calc(100% + 0.5rem) calc(100% + 0.5rem); background-size: 100% auto; background-image: url(assets/media/svg/patterns/rhone-2.svg)">
													...
													<div class="card-body">
														...
														<p class="text-muted font-size-lg mt-5 mb-10">Outlines keep you and honest Indulging honest</p>
														<a href='#' class="btn btn-link btn-link-warning font-weight-bold">Create Report
														<span class="svg-icon svg-icon-lg svg-icon-warning">
															<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
