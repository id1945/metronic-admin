...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Stacked Cards | Keenthemes</title>
		<meta name="description" content="Stacked card examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Stacked Cards</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Stacked Cards</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
									...
									<code>.card-stretch-{half|third|fourth}</code>classes to have stretch cards in Bootstrap Grid.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Example-->
								<!--begin::Row-->
										...
										<div class="card card-custom card-stretch">
											<div class="card-header">
												<div class="card-title">
													...
													<small>same height cards</small></h3>
												</div>
											</div>
									...
									<div class="col-lg-4">
										...
										<div class="card card-custom card-stretch card-stretch-half gutter-b">
											<div class="card-header">
												<div class="card-title">
													<h3 class="card-label">Card Title
													<small>half height card</small></h3>
												</div>
											</div>
									...
									<div class="col-lg-6">
										...
										<div class="card card-custom card-stretch card-stretch-fourth gutter-b">
											<div class="card-header">
												<div class="card-title">
													<h3 class="card-label">Card Title
													<small>fourth height card</small></h3>
												</div>
											</div>
											<div class="card-body">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled. Lorem Ipsum.</div>
										</div>
