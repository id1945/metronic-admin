...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">The Metronic Datatable component supports local or remote data source. For remote data you can specify a remote data source that returns data in JSON/JSONP format. In this example the grid fetches its data from a remote JSON file. It also defines the schema model of the data source received from the remote data source. In addition to the visualization, the Datatable provides built-in support for operations over data such as sorting, filtering and paging performed in user browser (frontend).</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											...
											<span class="d-block text-muted pt-2 font-size-sm">Events API examples</span></h3>
										</div>
									...
									<div class="card-body">
										...
										<div class="mt-10">
											...
											<div class="mt-5">
												<button class="btn btn-light-primary font-weight-bold mr-2" type="button" id="kt_datatable_clear">Clear Console</button>
		...
		<script src="assets/js/pages/crud/ktdatatable/api/events.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>