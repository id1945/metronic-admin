...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Metronic Image Input | Keenthemes</title>
		<meta name="description" content="Custom made image attachment for form submition with dynamic preview" />
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<b class="mr-2">KTImageInput</b>is Metronic's custom made plugin that provides an image attachment for form submitions with dynamic preview.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
