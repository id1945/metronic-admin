...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Bootstrap Daterangepicker | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Bootstrap Daterangepicker</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Daterangepicker</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://github.com/dangrossman/daterangepicker" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
      ...
      jQuery(document).ready(function() {
       KTBootstrapDaterangepicker.init();
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class='input-group' id='kt_daterangepicker_4'>
														<input type='text' class="form-control" readonly="readonly" placeholder="Select date &amp; time range" />
														<div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-calendar-check-o"></i>
															</span>
												...
												<div class="modal-body">
													<div class="form-group row">
														...
														<div class="col-lg-6 col-md-9 col-sm-12">
															<input class="form-control" id="kt_daterangepicker_1_modal" readonly="readonly" placeholder="Select time" type="text" />
														</div>
													</div>
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Input Group Setup</label>
      ...
      jQuery(document).ready(function() {
       KTBootstrapDaterangepicker.init();
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class='input-group' id='kt_daterangepicker_2_validate'>
														<input type='text' class="form-control is-invalid" readonly="readonly" placeholder="Select date range" />
														<div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-calendar-check-o"></i>
															</span>
