...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Typeahead | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Typeahead</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Typeahead</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">typeahead.js a flexible JavaScript library that provides a strong foundation for building robust typeaheads. typeahead.js is a fast and fully-featured autocomplete library.
									...
									<a class="font-weight-bold" href="https://github.com/twitter/typeahead.js" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
      ...
      jQuery(document).ready(function() {
          KTTypeahead.init();
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="typeahead">
														<input class="form-control" id="kt_typeahead_1" type="text" dir="ltr" placeholder="States of USA" />
													</div>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="typeahead">
														<input class="form-control" id="kt_typeahead_2" type="text" dir="ltr" placeholder="States of USA" />
													</div>
													<div class="form-text text-muted">Bloodhound offers advanced functionalities such as prefetching and backfilling with remote data.</div>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Prefetch</label>
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="typeahead">
														<input class="form-control" id="kt_typeahead_3" type="text" dir="ltr" placeholder="Countries" />
													</div>
													<div class="form-text text-muted">Prefetched data is fetched and processed on initialization</div>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="typeahead">
														<input class="form-control" id="kt_typeahead_4" type="text" dir="ltr" placeholder="Oscar winners" />
													</div>
													<div class="form-text text-muted">Custom templates give you full control over how suggestions get rendered</div>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="typeahead">
														<input class="form-control" id="kt_typeahead_5" type="text" dir="ltr" placeholder="Select an option" />
													</div>
													<div class="form-text text-muted">Remote data is only used when the data provided by local and prefetch is insufficient</div>
												</div>
											</div>
												...
												<div class="modal-body">
													<div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="typeahead">
																<input class="form-control" id="kt_typeahead_1_modal" dir="ltr" type="text" placeholder="States of USA" />
															</div>
														</div>
													</div>
													<div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="typeahead">
																<input class="form-control" id="kt_typeahead_2_modal" dir="ltr" type="text" placeholder="States of USA" />
															</div>
															<div class="form-text text-muted">Bloodhound offers advanced functionalities such as prefetching and backfilling with remote data.</div>
														</div>
													</div>
													<div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="typeahead">
																<input class="form-control" id="kt_typeahead_3_modal" dir="ltr" type="text" placeholder="Countries" />
															</div>
															<div class="form-text text-muted">Prefetched data is fetched and processed on initialization</div>
														</div>
													</div>
      ...
      jQuery(document).ready(function() {
          KTTypeahead.init();
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12 is-valid">
													<div class="typeahead">
														<input class="form-control is-valid" id="kt_typeahead_1_validate" dir="ltr" type="text" placeholder="States of USA" />
													</div>
													<div class="valid-feedback">Success! You've done it.</div>
													<span class="form-text text-muted">Example help text that remains unchanged.</span>
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12 is-invalid">
													<div class="typeahead">
														<input class="form-control is-invalid" id="kt_typeahead_2_validate" dir="ltr" type="text" placeholder="States of USA" />
													</div>
													<div class="invalid-feedback">Shucks, check the formatting of that and try again.</div>
													<span class="form-text text-muted">Example help text that remains unchanged.</span>
												</div>
		...
		<script src="assets/js/pages/crud/forms/widgets/typeahead.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>