...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Clipboard | Keenthemes</title>
		<meta name="description" content="Clipboard examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Clipboard</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Clipboard</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://github.com/zenorocha/clipboard.js" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
        ...
        KTClipboardDemo.init();
											...
											<div class="form-group row">
												...
												<div class="col-lg-6 col-md-9 col-sm-12">
													<div class="input-group">
														<input type="text" class="form-control" id="kt_clipboard_1" placeholder="Type some value to copy" />
														<div class="input-group-append">
															<a href="#" class="btn btn-secondary" data-clipboard="true" data-clipboard-target="#kt_clipboard_1">
											...
											<div class="form-group row">
												...
												<div class="col-lg-6 col-md-9 col-sm-12">
													<textarea class="form-control" id="kt_clipboard_2" rows="6">Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</textarea>
													<div class="mt-4"></div>
													<a href="#" class="btn btn-secondary" data-clipboard="true" data-clipboard-target="#kt_clipboard_2">
											...
											<div class="form-group row">
												...
												<div class="col-lg-6 col-md-9 col-sm-12">
													<textarea class="form-control" id="kt_clipboard_3" rows="6">Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</textarea>
													<div class="mt-4"></div>
													<a href="#" class="btn btn-primary" data-clipboard="true" data-clipboard-action="cut" data-clipboard-target="#kt_clipboard_3">
											...
											<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Copy From Element</label>
												<div class="col-lg-6 col-md-9 col-sm-12">
													<div id="kt_clipboard_4" class="rounded bg-gray-100 p-5">Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</div>
													<div class="mt-4"></div>
