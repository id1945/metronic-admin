...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Bootstrap Timepicker | Keenthemes</title>
		<meta name="description" content="Bootstrap timepicker examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Bootstrap Timepicker</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Timepicker</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<a href="http://jdewit.github.io/bootstrap-timepicker/" class="font-weight-bold" target="_blank">Demo Page</a>or
									<a class="font-weight-bold" href="https://github.com/jdewit/bootstrap-timepicker" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
      ...
      jQuery(document).ready(function() {
       KTBootstrapTimepicker.init();
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="input-group timepicker">
														<input class="form-control" id="kt_timepicker_2" readonly="readonly" placeholder="Select time" type="text" />
														<div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-clock-o"></i>
															</span>
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="input-group timepicker">
														...
														<input class="form-control" id="kt_timepicker_3" readonly="readonly" placeholder="Select time" type="text" />
													</div>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="input-group timepicker">
														...
														<input class="form-control" id="kt_timepicker_4" readonly="readonly" value="10:30:20 AM" type="text" />
													</div>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="modal-body">
													<div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input class="form-control" id="kt_timepicker_1_modal" readonly="readonly" placeholder="Select time" type="text" />
														</div>
													</div>
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Current Time</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="input-group timepicker">
																<input class="form-control" id="kt_timepicker_2_modal" readonly="readonly" placeholder="Select time" type="text" />
																<div class="input-group-append">
																	<span class="input-group-text">
																		<i class="la la-clock-o"></i>
																	</span>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="input-group timepicker">
																...
																<input class="form-control" id="kt_timepicker_3_modal" readonly="readonly" placeholder="Select time" type="text" />
															</div>
														</div>
													</div>
													<div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="input-group timepicker">
																...
																<input class="form-control" id="kt_timepicker_4_modal" readonly="readonly" value="10:30:20 AM" type="text" />
															</div>
														</div>
													</div>
												</div>
      ...
      jQuery(document).ready(function() {
       KTBootstrapTimepicker.init();
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="input-group timepicker">
														<input class="form-control is-valid" id="kt_timepicker_1_validate" readonly="readonly" placeholder="Select time" type="text" />
														<div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-clock-o"></i>
															</span>
											...
											<div class="form-group row has-danger">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="input-group timepicker">
														<input class="form-control is-invalid" id="kt_timepicker_2_validate" readonly="readonly" placeholder="Select time" type="text" />
														<div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-clock-o"></i>
															</span>
