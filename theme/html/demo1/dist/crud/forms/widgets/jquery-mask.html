...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>JQuery Mask | Keenthemes</title>
		<meta name="description" content="JQuery Mask plugin" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">jQuery Mask</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">jQuery Mask</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">jquery-mask-plugin is a jQuery plugin which create an input mask. An input mask helps the user with the input by ensuring a predefined format.This can be useful for dates, numerics, phone numbers, etc.
									<br />For more info please visit the plugin's
									<a class="font-weight-bold mx-2" href="https://igorescobar.github.io/jQuery-Mask-Plugin/" target="_blank">Demo Page</a>or
									<a class="font-weight-bold mx-2" href="https://github.com/igorescobar/jQuery-Mask-Plugin" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
