...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Tagify | Keenthemes</title>
		<meta name="description" content="Lightweight and powerful input tags plugin" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Tagify</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Tagify</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://github.com/yairEO/tagify" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<div class="row">
									<div class="col-lg-12">
											...
											<form class="form" action="?" method="post">
												<div class="card-body">
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 col-md-9 col-sm-12">
															<input id="kt_tagify_4" class="form-control" name='tags3' placeholder='Write some tags' value='css, html, javascript, angular, vue, react' />
													...
													<div class="form-group row">
														...
														<div class="col-lg-6 col-md-9 col-sm-12">
															<input id="kt_tagify_6" class="form-control" name='tags4' placeholder='Write some tags' value='css, html, javascript, angular, vue, react' />
															<div class="mt-3 text-muted">In this example, the dropdown.enabled setting is set (minimum charactes typed to show the dropdown) to 3. Maximum number of tags is set to 6</div>
														</div>
													</div>
												</div>
