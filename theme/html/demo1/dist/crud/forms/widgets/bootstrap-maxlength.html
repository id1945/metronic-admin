...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Bootstrap Maxlength | Keenthemes</title>
		<meta name="description" content="Bootstrap maxlength examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Bootstrap Maxlength</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Maxlength</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">This plugin integrates by default with Twitter bootstrap using badges to display the maximum length of the field where the user is inserting text. Uses the HTML5 attribute "maxlength" to work.
									<br />For more info please visit the plugin's
									<a class="font-weight-bold" href="http://mimo84.github.io/bootstrap-maxlength/" target="_blank">Demo Page</a>or
									<a class="font-weight-bold" href="https://github.com/mimo84/bootstrap-maxlength" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
      ...
      jQuery(document).ready(function() {
       KTBootstrapMaxlength.init();
											...
											<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Default Usage</label>
												<div class="col-lg-4 col-md-9 col-sm-12">
													<input class="form-control" id="kt_maxlength_1" maxlength="3" placeholder="" type="text" />
													<span class="form-text text-muted">The badge will show up by default when the remaining chars are 3 or less</span>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Threshold Demo</label>
												<div class="col-lg-4 col-md-9 col-sm-12">
													<input class="form-control" id="kt_maxlength_2" maxlength="7" placeholder="" type="text" />
													<span class="form-text text-muted">Set threshold value to show there are 5 chars or less</span>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Always Show</label>
												<div class="col-lg-4 col-md-9 col-sm-12">
													<input class="form-control" id="kt_maxlength_3" maxlength="6" placeholder="" type="text" />
													<span class="form-text text-muted">Show the counter on input focus</span>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Custom Text</label>
												<div class="col-lg-4 col-md-9 col-sm-12">
													<input class="form-control" id="kt_maxlength_4" maxlength="8" placeholder="" type="text" />
													<span class="form-text text-muted">Display custom text on input focus</span>
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Positions</label>
												<div class="col-lg-4 col-md-9 col-sm-12">
													<input class="form-control" id="kt_maxlength_6_1" maxlength="8" placeholder="Top left" type="text" />
													<div class="mt-3"></div>
													<input class="form-control" id="kt_maxlength_6_2" maxlength="8" placeholder="Top right" type="text" />
													<div class="mt-3"></div>
													<input class="form-control" id="kt_maxlength_6_3" maxlength="8" placeholder="Bottom left" type="text" />
													<div class="mt-3"></div>
													<input class="form-control" id="kt_maxlength_6_4" maxlength="8" placeholder="Bottom right" type="text" />
													<span class="form-text text-muted">The field counter can be positioned at the top, bottom, left or right.</span>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="modal-body">
													<div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input class="form-control" id="kt_maxlength_1_modal" maxlength="3" placeholder="" type="text" />
															<span class="form-text text-muted">The badge will show up by default when the remaining chars are 3 or less</span>
														</div>
													</div>
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Threshold Demo</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input class="form-control" id="kt_maxlength_2_modal" maxlength="7" placeholder="" type="text" />
															<span class="form-text text-muted">Set threshold value to show there are 5 chars or less</span>
														</div>
													</div>
													<div class="form-group row">
													...
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Custom Text</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input class="form-control" id="kt_maxlength_4_modal" maxlength="8" placeholder="" type="text" />
															<span class="form-text text-muted">Display custom text on input focus</span>
														</div>
													</div>
												</div>
