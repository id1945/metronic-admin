...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Form Repeater | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Form Repeater</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Form Repeater</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="https://github.com/DubFriend/jquery.repeater" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
												...
												<div class="card-body">
													...
													<div class="form-group row align-items-center">
														...
														<div class="col-lg-12 col-xl-8">
															<div class="checkbox-inline">
																<label class="checkbox">
																<input type="checkbox" name="comm2_email" />
																<span></span>Email</label>
																<label class="checkbox">
																<input type="checkbox" name="comm2_sms" />
																<span></span>SMS</label>
																<label class="checkbox">
																<input type="checkbox" name="comm2_phone" />
																<span></span>Phone</label>
															</div>
														</div>
													</div>
												...
												<div class="card-body">
													...
													<div class="form-group row align-items-center">
														...
														<div class="col-lg-12 col-xl-8">
															<div class="checkbox-inline">
																<label class="checkbox">
																<input type="checkbox" name="comm3_email" />
																<span></span>Email</label>
																<label class="checkbox">
																<input type="checkbox" name="comm3_sms" />
																<span></span>SMS</label>
																<label class="checkbox">
																<input type="checkbox" name="comm3_phone" />
																<span></span>Phone</label>
															</div>
														</div>
													</div>
