...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>NoUiSlider | Keenthemes</title>
		<meta name="description" content="NoUiSlider - input range slider examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">noUiSlider</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">noUiSlider</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">noUiSlider is a lightweight JavaScript range slider library with full multi-touch support. It fits wonderfully in responsive designs and has no dependencies.
									...
									<a class="font-weight-bold" href="https://github.com/leongersen/noUiSlider" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
...
<code class="language-js">
      ...
      jQuery(document).ready(function() {
       KTnoUiSliderDemos.init();
								...
								<!--end::Card-->
								<!--begin::Modal-->
								<div class="modal fade" id="kt_nouislider_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												...
												<div class="modal-body">
													<div class="form-group row mb-6">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="row align-items-center">
																<div class="col-6">
																	<input type="text" class="form-control" id="kt_nouislider_modal1_input" placeholder="Quantity" />
																</div>
																<div class="col-6">
													...
													<div class="form-group row mb-6">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="row align-items-center">
																<div class="col-6">
																	<input type="text" class="form-control" id="kt_nouislider_modal2_input" placeholder="Quantity" />
																</div>
																<div class="col-6">
													...
													<div class="form-group row mb-6">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="row align-items-center">
																<div class="col-3">
																	<input type="text" class="form-control" id="kt_nouislider_modal1.1_input" placeholder="Quantity" />
																</div>
																<div class="col-3">
																	<input type="text" class="form-control" id="kt_nouislider_modal1.2_input" placeholder="Quantity" />
																</div>
																<div class="col-6">
