...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Bootstrap Multiple Select Splitter | Keenthemes</title>
		<meta name="description" content="Bootstrap multiple select splitter examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Bootstrap Multiple Select Splitter</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Multiple Select Splitter</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">Transforms a &lt;select&gt; containing one or more &lt;optgroup&gt; into two chained &lt;select&gt;.
									<br />For more info please visit the plugin's
									<a class="font-weight-bold" href="https://github.com/poolerMF/bootstrap-multiselectsplitter" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
...
<code class="language-js">
      ...
      jQuery(document).ready(function() {
       KTBootstrapMultipleSelectsplitter.init();
		...
		<script src="assets/js/pages/crud/forms/widgets/bootstrap-multipleselectsplitter.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>