...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Autosize | Keenthemes</title>
		<meta name="description" content="Automatically adjust textarea height" />
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">A small, stand-alone script to automatically adjust textarea height. For more info please visit the plugin's
									<a class="font-weight-bold" href="http://www.jacklmoore.com/autosize/" target="_blank">Demo Page</a>or
									<a class="font-weight-bold" href="http://github.com/jackmoore/autosize" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
...
<code class="language-js">
		...
		<script src="assets/js/pages/crud/forms/widgets/autosize.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>