...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Ion Range Slider | Keenthemes</title>
		<meta name="description" content="Ion range slider examples" />
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">ion Range Slider</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Ion Range Slider</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<a class="font-weight-bold" href="http://ionden.com/a/plugins/ion.rangeSlider/demo.html" target="_blank">Demo Page</a>or
									<a class="font-weight-bold" href="https://github.com/IonDen/ion.rangeSlider" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
       ...
       KTIONRangeSlider.init();
											...
											<div class="form-group row mb-13">
												...
												<div class="col-lg-8 col-md-9 col-sm-12">
													...
													<div class="form-text text-muted mt-5">Set type to double and specify range, also showing grid and adding prefix "$"</div>
												</div>
											</div>
											<div class="form-group row mb-13">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Range &amp; Step</label>
											...
											<div class="form-group row mb-13">
												...
												<div class="col-lg-8 col-md-9 col-sm-12">
													...
													<div class="form-text text-muted mt-5">Set up range with fractional values, using fractional step</div>
												</div>
											</div>
											<div class="form-group row mb-13">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Using Postfixes</label>
