...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>CKEditor Balloon Block | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">CKEditor Balloon Block</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Form Text Editors</a>
											</li>
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">CKEditor</a>
											</li>
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">CKEditor Balloon Block</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">CKEditor is a proven, enterprise-grade WYSIWYG HTML editor with wide browser compatibility, including legacy browsers.
									<br />For more info please visit the plugin's
									<a class="font-weight-bold" href="https://ckeditor.com/docs/ckeditor5/latest/examples/builds/balloon-block-editor.html" target="_blank">Demo Page</a>or
									<a class="font-weight-bold" href="https://github.com/ckeditor/ckeditor5" target="_blank">Github Repo</a>.</div>
								</div>
								<!--end::Notice-->
								<div class="row">
									<div class="col-lg-6">
									...
									<div class="col-lg-6">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<div class="card-body">
												...
												<a href="#">Minitial content of the editor</a>. Lorem Ipsum is simply dummy text of the
												<em>printing and typesetting</em>industry.</div>
												<!--begin: Code-->
												<div class="example-code mt-10">
													<ul class="example-nav nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-2x">
														<li class="nav-item">
...
<code class="language-js">
		...
		<script src="assets/js/pages/crud/forms/editors/ckeditor-balloon-block.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>