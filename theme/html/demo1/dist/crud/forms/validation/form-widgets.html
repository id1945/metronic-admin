...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Form Widgets | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Form Widgets</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
      ...
      $('#kt_typeahead').bind('typeahead:select', function(ev, suggestion) {
       ...
       validator.revalidateField('typeahead');
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 col-md-9 col-sm-12">
													<div class="input-group" id='kt_daterangepicker'>
														<input type="text" class="form-control" readonly="readonly" name="daterangepicker" placeholder="Select date range" />
														<div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-calendar-check-o"></i>
															</span>
