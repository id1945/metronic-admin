...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Options | Keenthemes</title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Options</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Mega Options</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
																...
																<div class="col-lg-6">
																	<label class="option">
																		...
																		<span class="option-label">
																			...
																			<span class="option-body">Estimated 14-20 Day Shipping (Duties and taxes may be due)</span>
																		</span>
																	</label>
																</div>
																<div class="col-lg-6">
																	<label class="option">
																		...
																		<span class="option-label">
																			...
																			<span class="option-body">Estimated 2-5 Day Shipping (Duties and taxes may be due)</span>
																		</span>
																	</label>
																</div>
															</div>
