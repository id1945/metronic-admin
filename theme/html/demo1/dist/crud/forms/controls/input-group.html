							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Input Groups</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item text-muted">
												<a href="" class="text-muted">Input Groups</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
												...
												<div class="card-body">
													<div class="form-group">
														<div class="alert alert-custom alert-default" role="alert">
															...
															<a class="font-weight-bold" href="?page=components/icons/fontawesome5">Fontawesome 5</a>,
															<a class="font-weight-bold" href="?page=components/icons/duo-tone">Duotone</a>,
															<a class="font-weight-bold" href="?page=components/icons/lineawesome">Lineawesome</a>or
															<a class="font-weight-bold" href="?page=components/icons/socicons">Socicons</a>icons.</div>
														</div>
													</div>
													<div class="form-group">
												...
												<div class="card-body">
													<div class="form-group">
														<div class="alert alert-custom alert-default" role="alert">
															...
															<div class="alert-text">Easily extend form controls by adding text, buttons, icons, or button groups on either side of the input.</div>
														</div>
													</div>
													<div class="form-group">
														<label>Left Addon</label>
												...
												<div class="card-body">
													<div class="form-group">
														<div class="alert alert-custom alert-default" role="alert">
															...
															<code>.input-group</code>itself and contents within will automatically resize.</div>
														</div>
													</div>
													<div class="form-group">
												...
												<div class="card-body">
													<div class="form-group">
														<div class="alert alert-custom alert-default" role="alert">
															...
															<div class="alert-text">Place any checkbox or radio option within an input group’s addon instead of text.</div>
														</div>
													</div>
													<div class="form-group">
												...
												<div class="card-body">
													<div class="form-group">
														<div class="alert alert-custom alert-default" role="alert">
															...
															<code>.input-group-append</code>for proper alignment and sizing. This is required due to default browser styles that cannot be overridden.</div>
														</div>
													</div>
													<div class="form-group">
